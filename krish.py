...
def talk(audio):
    ...
    for line in audio.splitlines():
        text_to_speech = gTTS(text=audio, lang="en-in")
        text_to_speech.save("D:/KRISH-master/audio.mp3")
        mixer.init()
...
def krish(command):
    ...
    # please create and use your own API it is free
        ...
        talk("Hello! I am KRISH. How can I help you?")
        time.sleep(2)
